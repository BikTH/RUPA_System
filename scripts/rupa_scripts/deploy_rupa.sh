...
echo ">>> Fin de l'installation de RUPA System..."
...
# On sauvegarde les variables globales dans un fichier temporaire:
# pour les utiliser dans le script d'installation
# (install.sh) et pour le script de post-installation
declare -p GLOBAL_VARS > /tmp/global_vars.dump 
